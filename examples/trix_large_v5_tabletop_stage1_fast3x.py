...
J2_STAGE1_DELTA = +18.0
J2_DELTA = +30.0
J4_DELTA = +14.0
J3_DELTA = +0.0
WORK_DELTA = +0.0
J1_PREPOSITION_DELTA = +110.0
...
def main():
    ...
    try:
        ...
        # Stage 1: partial J2 approach.
        p1 = list(j1_pose)

        p1[1] = (
            start[1] + J2_STAGE1_DELTA
        )

        # Stage 2: shape forearm with J4 while J2 holds.
        p2 = list(p1)
        ...
        # Stage 3: continue J2 toward tabletop.
        # J3 deliberately remains at captured-start position.
        p3 = list(p2)
        ...
        move_pose(
            arm,
            j1_pose,
            "TRIX PREPOSITION: J1 +110 DEG RELATIVE -- CONTROLLED",
            watch_joint=1,
        )
        ...
        move_pose(
            arm,
            p1,
            "1/3 J2 INITIAL APPROACH +18 DEG",
            watch_joint=2,
        )
        ...
        print()
        print(
            "EXPLICIT J3 ENABLE BEFORE FINAL LOW APPROACH"
        )
        ...
        move_pose(
            arm,
            p3,
            "3/3 J2 FINAL TABLETOP APPROACH +30 DEG",
            watch_joint=2,
        )
        ...
        print()
        print(
            "J3 HOLD DURING FINAL TABLETOP APPROACH:"
        )
        ...
        move_pose(
            arm,
            p1,
            "RETURN 2/4: J4 -> START J4; J2 HELD +18",
            watch_joint=4,
        )
        ...
        print()
        print(
            f"J3 HOLD DRIFT DURING FINAL APPROACH: {moved:+.2f}°"
        )
